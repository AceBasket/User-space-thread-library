...
int thread_create(thread_t *newthread, void *(*func)(void *), void *funcarg) {
    ...
    new_thread_s->thread_id = (thread_t)new_thread_s;
    *newthread = new_thread_s->thread_id;
